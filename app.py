...
# --- 1. SETUP ---
st.set_page_config(page_title="Musik-IT Birka v16.2", layout="wide")
...
# --- 8. NY REGISTRERING ---
    ...
    with st.form("new_v16_2", clear_on_submit=True):
        c1, c2 = st.columns(2)
        ...
        if st.form_submit_button("✅ SPARA TILL DATABAS"):
            if f_mod and f_tag:
                ...
                st.warning("Vänligen fyll i Modell och Resurstagg!")
