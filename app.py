...
# --- 1. SETUP ---
st.set_page_config(page_title="Musik-IT Birka v12", layout="wide")
...
# --- 2. DATA CONNECTION (MED STRÄNG CACHE-KONTROLL) ---
conn = st.connection("gsheets", type=GSheetsConnection)

def get_data_force():
    """Hämtar data och tvingar Google Sheets att ignorera cache."""
    try:
        # TTL=0 är nyckeln här för att slippa fördröjning
...
def save_to_sheets(df):
    try:
        ...
        # Tömmer Streamlits interna cache efter skrivning
        st.cache_data.clear()
...
# --- 9. ÅTERLÄMNING ---
    ...
    # Tvinga omladdning vid varje sidvisning
...
# --- 10. ADMIN & INVENTERING (MED TVINGANDE SYNK-KNAPP) ---
elif menu == "⚙️ Admin & Inventering":
    if is_admin:
        # TVINGANDE SYNK-KNAPP LÄNGST UPP
